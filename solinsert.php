...
$sql="INSERT INTO paycheck (d_ssn,chk_num,salary,bonus,pay_date)VALUES('$d_ssn','$chk_num','$salary','$bonus','$pay_date')";
...
echo "<font size = 5>DATA INSERTED SUCESSFULLY!!!!</font></th></tr>";
echo "<br><br>";
...
<tr>
<td><font size = 5>bonus:  </font></td>
<td><input type="text" name="bon'" id="bonus" required="required" ></td>
</tr>
<tr>
